...
export default function NumbersPageClient() {
  ...
  const [editForm, setEditForm] = useState({ name: "", phone: "", group_id: "", custom_message: "", is_active: true })
                        ...
                        >
                          <Check
                            className={`mr-2 h-4 w-4 ${
                              editForm.group_id === "" ? "opacity-100" : "opacity-0"
                            }`}
                          />
                          Nenhum grupo
                        </CommandItem>
